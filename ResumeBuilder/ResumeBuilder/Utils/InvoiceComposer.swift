...
class InvoiceComposer: NSObject {
    ...
    func renderInvoice(personalInfo:PersonalInfo) -> String? {
        ...
        do {
            ...
            // The logo image.
            HTMLContent = HTMLContent.replacingOccurrences(of: "#LOGO_IMAGE#", with: DataHolder.sharedInstance.getImage(imageName: StringConstant().kProfileImage))
    ...
    func exportHTMLContentToPDF(HTMLContent: String) {
        ...
        pdfFilename = "\(getDocDir)/Invoice\(invoiceNumber ?? "1").pdf"
